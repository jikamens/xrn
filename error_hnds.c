...
static char XRNrcsid[] = "$Header: /d/src/cvsroot/xrn/error_hnds.c,v 1.5 1994-10-16 16:06:04 jik Exp $";
#endif
...
void ehInstallSignalHandlers()
{
     if (! app_resources.dumpCore) {
	  int i;
#if defined(sun) || defined(ultrix) || defined(_ANSI_C_SOURCE) || defined(__osf__) || defined(sgi)
	  void (*oldcatcher)();
#else
	  int (*oldcatcher)();
#endif
