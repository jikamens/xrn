...
/*
 * $Id: news.h,v 1.20 1996-06-09 16:43:48 jik Exp $
 */
...
#define FETCH_NEWSGROUPS	(1<<0)
#define FETCH_DATES		(1<<1)
#define FETCH_IDS		(1<<2)
#define FETCH_REFS		(1<<3)
#define FETCH_THREADS		(1<<4)
