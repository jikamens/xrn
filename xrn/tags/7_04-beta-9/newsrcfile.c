...
static char XRNrcsid[] = "$Id: newsrcfile.c,v 1.28 1995-09-22 09:33:50 jik Exp $";
#endif
...
int updatenewsrc()
{
	...
	active_cache_write(cache_file, Newsrc, MaxGroupNumber))
	return(FATAL);
