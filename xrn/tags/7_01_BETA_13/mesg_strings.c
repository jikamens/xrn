...
static char XRNrcsid[] = "$Id: mesg_strings.c,v 1.27 1995-01-25 03:17:52 jik Exp $";
#endif
 ...
 */
/* scanf format to get the newsgroupname, adjust to NEWSGROUPS_INDEX_MSG */
 ...
 */
/* scanf format um den Gruppennamen einzulesen, muss an NEWSGROUPS_INDEX_MSG angepasst sein */
...
/* < ERROR_FINDARTICLE > */
   "Valid article number not found in findArticle (cursor.c)",
...
/* < NO_MSG_TEMPLATE > */
    "Interner XRN Fehler: Keine Nachrichten Vorlage beim Aufruf des Editors.",
/* < CANT_EDITOR_CMD > */
...
/* < BAD_NEWSRC_LINE > */
    "Kann Zeile %d in der .newsrc Datei nicht interpretieren, \374bergehe sie.", /* line number */
/* < CANT_OPEN_NEWSRC_COPYING > */
...
/* < NO_SUCH_RMAIL > */
    "Keine solche RMAIL Datei `%s';  Datei anlegen?", /* file name */
/* < CANT_OPEN_RMAIL > */
...
/* < NO_APP_DEFAULTS > */
    "Die  XRN Application Defaults Datei ist nicht vorhanden.  M\366glicherweise gehen einige XRN Funktionen nicht.\nNormalerweise sollte die XRN Application Defaults Datei als `/usr/lib/X11/app-defaults/%s' oder als `$OPENWINHOME/lib/app-defaults/%s'  f\374r OpenWindows vorhanden sein", /* program class Name (twice) */
/* < VERSIONS > */
...
/* < ARE_YOU_SURE > */
   "Sind Sie sicher?",
/* SUBED and UNSUBED string must have the same len */
/* < SUBED >  */ 
   "abboniert      ",
/* < UNSUBED > */
   "nicht abboniert",
...
/* < ERROR_UNSUP_TRANS > */
   "Nicht unterst\344tzte \334berstzung: %d nach %d", /* transition from, to */
/* < POST_FOLLOWUP > */
   "Artikel",
/* < FOLLOWUP_REPLY > */ 
...
/* < ERROR_FINDARTICLE > */
   "G\374ltige Artikelnummer nicht gefunden in findArticle (cursor.c)",
/* < ERROR_STRIP_LEAVE_HEADERS > */
   "Es darf nur eine der Ressourcen `stripHeaders', `leaveHeaders' angegeben werden.",
/* < ERROR_REQUEST_FAILED > */
   "        Request was: `%s'\n        Failing response was: `%s'", /* command, message */
/* < ASK_UPDATE_NEWSRC > */
    ".newsrc Datei wurde von einem anderen Programm ver\344ndert. Trotzdem schreiben?",
};
