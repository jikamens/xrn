...
static char XRNrcsid[] = "$Id: server.c,v 1.45 1995-01-25 03:17:52 jik Exp $";
#endif
...
Boolean getauthorlist(newsgroup, artfirst, artlast, unreadonly, max)
    ...
    int max;
{
    char command[MESSAGE_SIZE], message[MESSAGE_SIZE], authbuf[MESSAGE_SIZE];
