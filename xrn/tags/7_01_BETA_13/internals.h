...
/*
 * $Id: internals.h,v 1.12 1995-01-25 03:17:52 jik Exp $
 */
...
#define KILL_LOCAL 1
extern void killItem _ARGUMENTS((struct newsgroup *, char *,int));
...
extern char *getPrevSubject _ARGUMENTS((void));
...
extern void rescanServer _ARGUMENTS((void));
...
#define ALL 0
#define UNREAD 1
extern char *getSubjects _ARGUMENTS((int, art_num));

/* build and return the status string */
extern char *getStatusString _ARGUMENTS((int));

extern void bogusNewsgroup _ARGUMENTS((void));
