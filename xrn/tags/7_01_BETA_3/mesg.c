...
static char XRNrcsid[] = "$Header: /d/src/cvsroot/xrn/mesg.c,v 1.11 1994-11-13 20:50:48 jik Exp $";
#endif
...
/* XmNlabelString in app-defaults file */
	...
	(void) sprintf(MesgString, "%s: ", time_str);
	(void) vsprintf(&MesgString[strlen(MesgString)], fmtString, args);
