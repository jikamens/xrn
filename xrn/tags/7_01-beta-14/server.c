...
static char XRNrcsid[] = "$Id: server.c,v 1.50 1995-01-30 19:29:30 jik Exp $";
#endif
    ...
    int max;
{
    ...
    return getlist(newsgroup, artfirst, artlast, unreadonly, max,
		   "subject", subjectFixFunction, offset);
}
