...
static char XRNrcsid[] = "$Id: xrn.c,v 1.19 1994-12-15 18:34:01 jik Exp $";
#endif
    ...
    char **argv;
{
...
#else
    XtAppSetWarningHandler(TopContext, (XtErrorHandler) XawNothing);
...
#else
    {
      ...
      XmStringFree(xs);
      xs = XmStringCreate(" ", XmSTRING_DEFAULT_CHARSET);
      XtSetArg(labelArgs[0], XmNlabelString, xs);
    }
#endif
#endif
...
#if defined(MOTIF) && defined(EDITRES) && (XtSpecificationRelease > 4)
