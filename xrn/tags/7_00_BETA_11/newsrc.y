...
static char XRNrcsid[] = "$Header: /d/src/cvsroot/xrn/newsrc.y,v 1.2 1994-10-10 06:21:12 jik Exp $";
#endif
...
newsrc_line : NAME SEPARATOR artlist EOL
			...
			mesgPane(XRN_SERIOUS, BOGUS_NG_REMOVING_MSG, $1);
		    } else {
			...
			if (IS_NOENTRY(newsgroup)) {
			    ...
			    mesgPane(XRN_SERIOUS, DUP_NEWSRC_ENTRY_MSG, $1);
			}
		    }
		    XtFree($1);
	        }
	    ...
	    | error EOL {
		mesgPane(XRN_SERIOUS, BAD_NEWSRC_LINE_MSG,
