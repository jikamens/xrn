...
/*
 * $Id: server.h,v 1.23 1996-06-09 16:44:19 jik Exp $
 */
...
extern void getactive _ARGUMENTS((/* Boolean */ int));
...
extern int parse_active_line _ARGUMENTS((char *, /* unsigned char */ int,
					 struct newsgroup **));
