...
/*
 * $Header: /d/src/cvsroot/xrn/config.h,v 1.22 1994-10-12 13:25:15 jik Exp $
 */
...
#if defined(hpux) || defined(clipper) || (defined(sony) && defined(SVR4)) || (defined(i386) && defined(SYSV))
