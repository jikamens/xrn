...
/*
 * $Header: /d/src/cvsroot/xrn/server.h,v 1.3 1994-10-10 18:46:30 jik Exp $
 */
...
extern void close_server _ARGUMENTS(());
...
extern void getactive _ARGUMENTS(());

/* see if the subscribed to groups have 0 or 1 article */
extern void badActiveFileCheck _ARGUMENTS(());
...
extern void getsubjectlist _ARGUMENTS((struct newsgroup *,art_num,art_num,Boolean));
extern void getauthorlist _ARGUMENTS((struct newsgroup *,art_num,art_num,Boolean));
extern void getlineslist _ARGUMENTS((struct newsgroup *,art_num,art_num,Boolean));
