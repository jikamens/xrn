...
static char XRNrcsid[] = "$Header: /d/src/cvsroot/xrn/internals.c,v 1.11 1994-10-10 18:46:30 jik Exp $";
#endif
...
static char *strip _ARGUMENTS((char *, Boolean));
...
static int findUnreadArticle _ARGUMENTS((struct newsgroup *, Boolean));
