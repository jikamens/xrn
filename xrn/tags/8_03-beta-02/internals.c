...
static char XRNrcsid[] = "$Id: internals.c,v 1.149 1996-06-05 14:57:23 jik Exp $";
#endif
...
# endif /* ! SYSV_REGEX */
  ...
  strncpy(pattern, ptr, MIN(ptr2 - ptr, BUFFER_SIZE));
  pattern[MIN(ptr2 - ptr, BUFFER_SIZE - 1)] = '\0';
