...
static char XRNrcsid[] = "$Id: cursor.c,v 1.14 1994-12-16 03:10:41 jik Exp $";
#endif
 ...
 * Unsets the selection if unset is true.
 */
int getSelection(twin, tstring, left, right, unset)
