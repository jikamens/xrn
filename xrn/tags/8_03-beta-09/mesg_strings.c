...
static char XRNrcsid[] = "$Id: mesg_strings.c,v 1.63 1996-06-16 15:40:36 jik Exp $";
#endif
...
/* < CANT_OPEN_KILL > */
    "Cannot open kill file (`%s') for newsgroup `%s': %s.", /* file name, newsgroup name, error string */
/* < CANT_OPEN_GLOBAL_KILL > */
    "Cannot open global kill file (`%s'): %s.", /* file name, error string */
...
/* < CANT_OPEN_KILL > */
    "Kann Killfile (`%s') f\374r Newsgruppe `%s' nicht \366ffnen: %s.", /* file name, Newsgruppe name, Fehler string */
/* < CANT_OPEN_GLOBAL_KILL > */
    "Cannot open global kill file (`%s'): %s.", /* file name, error string */
/* < MALFORMED_KILL_ENTRY > */
    "Error in KILL file entry `%s' in KILL file `%s': %s.", /* entry, file, reason for error */
