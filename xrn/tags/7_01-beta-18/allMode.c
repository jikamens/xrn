    ...
    long left, right;
{
    ...
    TextInvalidate(ArticleText, string, left, right);
    current = right;
    ...
    String group;
{
    ...
    /*
      I'd rather put this in an initializer in the declaration for
      oldGroup above, but some old, buggy C compilers don't support
      aggregate initialization of non-statics.  Sigh.
      */
    *oldGroup = '\0';
