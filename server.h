...
/*
 * $Header: /d/src/cvsroot/xrn/server.h,v 1.4 1994-10-11 14:21:30 jik Exp $
 */
...
extern void getsubjectlist _ARGUMENTS((struct newsgroup *,art_num,art_num,
				/* Boolean */ int));
extern void getauthorlist _ARGUMENTS((struct newsgroup *,art_num,art_num,
				/* Boolean */ int));
extern void getlineslist _ARGUMENTS((struct newsgroup *,art_num,art_num,
				/* Boolean */ int));
