...
static char XRNrcsid[] = "$Id: internals.c,v 1.201 1997-04-07 21:19:13 jik Exp $";
#endif
...
/*
  Returns -1 if the article exists but is not in the specified
  newsgroup (or is not in the currently available range in the
  newsgroup), 0 if the article doesn't exist or has no xref header, or
