...
static char XRNrcsid[] = "$Id: internals.c,v 1.170 1996-06-16 18:39:40 jik Exp $";
#endif
...
# endif
	  ...
	  if (KILL_MATCH(subject) || KILL_MATCH(from) ||
	    ...
	    entry->entry.last_used = (now ? now : (now = time(0)));
    ...
    Boolean prefetching;
{
    ...
    /*
      ...
      */
    read_kill_file(newsgroup, KILL_LOCAL);
    read_kill_file(newsgroup, KILL_GLOBAL);
