...
/*
 * $Id: config.h,v 1.62 1995-10-05 20:14:38 jik Exp $
 */
...
#ifdef USE_LOCALTIME
# if defined(SYSV) || defined(ultrix) || defined(apollo) ||  defined(sun) || defined(linux)
#define REALLY_USE_LOCALTIME
#endif /* systems on which USE_LOCALTIME is supported */
#ifndef linux /* I do not know what other systems support mktime() */
#define NO_MKTIME
#endif
#endif
...
#if !defined(POSIX_REGEX) && !defined(__uxp__) && (defined(macII) || defined(aiws) || (defined(hpux) || defined(__hpux)) || (defined(SYSV) && !defined(i386) && !defined(_IBMR2)) || defined(SVR4) || defined(SCO))
#define SYSV_REGEX
#ifndef SYSV
#define SYSV
#endif
...
#if defined(mips) || (defined(hpux) || defined(__hpux)) || defined(sun) || (defined(i386) && !defined(sequent)) || defined(_IBMR2) || defined(DGUX) || defined(__uxp__)
#define USE_PUTENV
#endif
