...
/*
 * $Id: config.h,v 1.53 1995-03-17 00:35:03 jik Exp $
 */
 ...
 * of the xrn window.  This is relevant only if you have keyboard
 * accelerators defined for your buttons.  You probably don't, so you
 * probably don't need to define this.
 *
