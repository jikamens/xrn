...
/*
 * $Id: config.h,v 1.58 1995-09-10 12:34:42 jik Exp $
 */
...
#if !defined(POSIX_REGEX) && (defined(macII) || defined(aiws) || (defined(hpux) || defined(__hpux)) || (defined(SYSV) && !defined(i386) && !defined(_IBMR2)) || defined(SVR4) || defined(SCO))
#define SYSV_REGEX
#ifndef SYSV
#define SYSV
#endif
...
#if defined(mips) || (defined(hpux) || defined(__hpux)) || defined(sun) || (defined(i386) && !defined(sequent)) || defined(_IBMR2) || defined(DGUX)
#define USE_PUTENV
#endif
