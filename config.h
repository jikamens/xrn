...
/*
 * $Header: /d/src/cvsroot/xrn/config.h,v 1.33 1994-11-09 23:38:05 jik Exp $
 */
 ...
 *  .UUCP
 *
 * You must define this (and then uncomment the definition).
 *
 ...
 * (but you still need to define it to something).
 *
 */
...
#if defined(macII) || defined(aiws) || defined(hpux) || (defined(SYSV) && !defined(i386) && !defined(_IBMR2)) || defined(SVR4) || defined(SCO)
#define SYSV_REGEX
#ifndef SYSV
#define SYSV
#endif
...
/* strstr function */
/*
 * strstr isn't needed under SunOS 4.1.3 and above.  See the comment
 * above strtok, above, for why I'm checking the "sparc", "sun" and
 * "unix" symbols to determine this.
 */
