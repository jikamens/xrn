...
static char XRNrcsid[] = "$Id: buttons.c,v 1.49 1994-12-16 03:09:55 jik Exp $";
#endif
...
void redrawNewsgroupTextWidget()
{
    ...
    if (*CurrentIndexGroup && STREQ(CurrentIndexGroup, LastGroup)) {
 ...
 */
static void updateNewsgroupMode(prefetch)
    Boolean prefetch;
{
    if (Mode != NEWSGROUP_MODE)
	return;
