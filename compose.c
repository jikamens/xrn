...
static char XRNrcsid[] = "$Header: /d/src/cvsroot/xrn/compose.c,v 1.10 1994-10-10 18:46:30 jik Exp $";
#endif
    ...
    Cardinal *count;
{
    ...
    if (count && (*count > 0) && (strncmp(string[0], "append") == 0))
	append = XRN_APPEND;
