...
static char XRNrcsid[] = "$Header: /d/src/cvsroot/xrn/mesg.c,v 1.8 1994-10-21 13:48:59 jik Exp $";
#endif
...
void mesgEnableAppend()
{
    default_append++;
}

void mesgDisableAppend()
{
    if (default_append)
	default_append--;
}
