...
static char XRNrcsid[] = "$Id: server.c,v 1.118 1997-01-09 02:10:21 jik Exp $";
#endif
...
static char *get_data_from_server _ARGUMENTS((void));

static char *get_data_from_server()
{
    ...
    int header, rotation, xlation;
{
	...
	if (*msg != '\0') {
		...
		if ((*msg == ' ') || (*msg == '\t')) { /* continuation line */
		    ...
		    if (ptr - msg + 1 > field_size) {
		      field_size = ptr - msg + 1;
		      field = XtRealloc(field, field_size);
		    }
		    (void) strncpy(field, msg, ptr - msg);
		    field[ptr - msg] = '\0';
		    utDowncase(field);
...
Boolean verifyGroup(group, struct_ptr, no_cache)
char *group;
...
static Boolean getlist(newsgroup, artfirst, artlast, unreadonly, max,
		       field, offset, fixfunction, fixed_offset, required)
    struct newsgroup *newsgroup;
    art_num artfirst;
    art_num artlast;
    Boolean unreadonly;
...
Boolean getnewsgroupslist(newsgroup, artfirst, artlast, unreadonly, max)
    struct newsgroup *newsgroup;
    art_num artfirst;
    art_num artlast;
    Boolean unreadonly;
...
Boolean getxreflist(newsgroup, artfirst, artlast, unreadonly, max)
    struct newsgroup *newsgroup;
    art_num artfirst;
    art_num artlast;
    Boolean unreadonly;
...
Boolean getdatelist(newsgroup, artfirst, artlast, unreadonly, max)
    struct newsgroup *newsgroup;
    art_num artfirst;
    art_num artlast;
    Boolean unreadonly;
...
Boolean getidlist(newsgroup, artfirst, artlast, unreadonly, max)
    struct newsgroup *newsgroup;
    art_num artfirst;
    art_num artlast;
    Boolean unreadonly;
...
Boolean getreflist(newsgroup, artfirst, artlast, unreadonly, max)
    struct newsgroup *newsgroup;
    art_num artfirst;
    art_num artlast;
    Boolean unreadonly;
