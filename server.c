...
static char XRNrcsid[] = "$Header: /d/src/cvsroot/xrn/server.c,v 1.16 1994-11-08 18:23:24 jik Exp $";
#endif
...
void getactive()
{
	...
	for (re_num = 0, j = 0; j < i; j++) {
	    if (re_cache[re_num] = regcmp(re_list[j], 0)) {
		re_num++;
	    }
	}
	re_cache[re_num] = 0;
