...
static char XRNrcsid[] = "$Id: server.c,v 1.121 1997-01-12 03:41:22 jik Exp $";
#endif
...
typedef char * (*fixfunction) _ARGUMENTS((struct newsgroup *, art_num, char *));
...
static Boolean getlist(
		       ...
		       _ANSIDECL(fixfunction, 		fixfunction),
     ...
     _KNRDECL(fixfunction, 		fixfunction)
...
void xhdr(newsgroup, article, field, string)
    ...
    char **string;
{
    char buffer[BUFFER_SIZE], *message, *ptr;
