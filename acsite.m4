# XRN CHANGES: Disable the second regcomp test which contains an empty
# branch in the regex, which the documentation says isn't allowed and
# fails on NetBSD.
#
# XRN version BASED ON:
...
# XRN changed name
AC_DEFUN([XRN_CHECK_POSIX_REGCOMP],[
