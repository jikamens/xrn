...
static char XRNrcsid[] = "$Id: mesg_strings.c,v 1.66 1997-01-08 12:06:43 jik Exp $";
#endif
...
/* < KILL_ERROR_UNKNOWN_OPTION > */
    "Fehler in KILL-Datei Eintrag `%s' in KILL-Datei `%s': Unbekannte Option `%s'.", /* entry, file, unknown option */
/* < UNKNOWN_KILL_REGEXP_ERROR > */
