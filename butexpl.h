...
#define ARTKILLLOCAL_EXSTR	"Alle Artikel mit diesem Thema, in dieser Gruppe, f\374r alle Sitzungen als `gelesen' kennzeichnen."
#define ARTKILLGLOBAL_EXSTR	"Alle Artikel mit diesem Thema f\374r alle Sitzungen als `gelesen' kennzeichnen."
