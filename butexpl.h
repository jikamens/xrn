...
#define ARTNEXTGROUP_EXSTR	"Go to the next newsgroup, skipping newsgroup mode"
#define ARTCATCHUP_EXSTR	"Mark all articles (up to the middle-button selected article) in the group as read"
#define ARTFEEDUP_EXSTR		"Mark all articles in the current group as read and go to the next newsgroup "
...
#define ARTNEXTGROUP_EXSTR	"Zur n\344chsten News-Gruppe gehen, dabei Gruppenauswahl \374bergehen."
#define ARTCATCHUP_EXSTR	"Alle Artikel (bis zum aktuellen) als `gelesen' kennzeichnen und Newsgruppe verlassen."
#define ARTFEEDUP_EXSTR		"Alle Artikel als `gelesen' kennzeichnen und Newsgruppe verlassen."
