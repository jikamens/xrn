...
static char XRNrcsid[] = "$Id: cursor.c,v 1.16 1995-01-25 03:17:52 jik Exp $";
#endif
...
void markAllString(tstring, left, right, status)
    char *tstring;			/* text string */
    long left, right;	/* boundaries of groups to be marked */
    char *status;			/* "subscribed" or "unsubscribed" */
{
    long temp, point;	/* positions used to move through string */
    int i;
